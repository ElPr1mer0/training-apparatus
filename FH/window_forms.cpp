...
void WINDOWS::SetHomeWindow(){    
    ...
    // ПРОФИЛЬ
    QWidget *w_back_ground = new QWidget(this, Qt::Widget);
    w_back_ground->setStyleSheet("background-color: rgb(230, 230, 255);");

    QWidget *w_back_ground2 = new QWidget;
    w_back_ground2->setStyleSheet("background-color: rgb(10, 230, 255);");

    QVBoxLayout *v_back_ground_l = new QVBoxLayout;
    h_home_l->addLayout(v_back_ground_l);

    v_back_ground_l->addWidget(w_back_ground,0,Qt::AlignLeft|Qt::AlignTop);
    v_back_ground_l->addWidget(w_back_ground2,0,Qt::AlignLeft|Qt::AlignTop);
    QLabel *lab_back_ground_image = new QLabel("HELLO",w_back_ground);
